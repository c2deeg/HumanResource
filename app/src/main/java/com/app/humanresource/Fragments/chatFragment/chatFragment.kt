...
import com.app.humanresource.Fragments.chatFragment.Presenter.chatPresenter
...
class chatFragment : Fragment(),chatView {
    ...
    override fun onCreateView(
        ...
        init(view)
        listeners(view)
        chatpresenter = chatPresenter(activity as FragmentActivity,this,chat_recyclerview)
        chatpresenter?.getAllUsersList()
...
//                "Shea",
//                "2.40pm",
//                "After five mins i will call you"
//            )
//        )
...
//        chatList.add(ChatListModelClass(R.drawable.imggirl, "Jac", "2.40pm", "Hey man"))
    ...
    private fun enableSwipeToDeleteAndUndo() {
        val swipeToDeleteCallback: SwipeToDeleteCallback1 =
            object : SwipeToDeleteCallback1(activity) {
                override fun onSwiped(viewHolder: RecyclerView.ViewHolder, i: Int) {
                    val position = viewHolder.adapterPosition
//                    val item: ChatListModelClass =
//                        chatListRecyclerAdapter?.getData()!!?.get(position)!!
