...
public class JobFilterDatum {

    @SerializedName("company")
    @Expose
    private JobFilterCompany company;
    ...
    @Expose
    private JobFilterCategory category;
    ...
    public JobFilterCompany getCompany() {
        return company;
    }

    public void setCompany(JobFilterCompany company) {
    ...
    public JobFilterCategory getCategory() {
        return category;
    }

    public void setCategory(JobFilterCategory category) {
