...
public class  PopularJobsMessage {

    @SerializedName("company")
    @Expose
    private PopularJobsCompany company;
    ...
    @Expose
    private PopularJobsCategory category;
    ...
    public PopularJobsCompany getCompany() {
        return company;
    }

    public void setCompany(PopularJobsCompany company) {
    ...
    public PopularJobsCategory getCategory() {
        return category;
    }

    public void setCategory(PopularJobsCategory category) {
