...
public class GetApplyJobsByIdJob {

    @SerializedName("company")
    @Expose
    private GetApplyJobsByIdCompany company;
    ...
    public GetApplyJobsByIdCompany getCompany() {
        return company;
    }

    public void setCompany(GetApplyJobsByIdCompany company) {
