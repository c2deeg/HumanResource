...
package com.app.humanresource.Models.GetJobById;

import com.google.gson.annotations.Expose;
import com.google.gson.annotations.SerializedName;

public class GetJobByIdData {

    @SerializedName("company")
    @Expose
    private  GetJobByIdCompany company;
    ...
    @Expose
    private  GetJobByIdCategory category;
    ...
    public  GetJobByIdCompany getCompany() {
        return company;
    }

    public void setCompany( GetJobByIdCompany company) {
    ...
    public  GetJobByIdCategory getCategory() {
        return category;
    }

    public void setCategory( GetJobByIdCategory category) {
