...
public class GetapplyJobByidJob {

    @SerializedName("company")
    @Expose
    private GetapplyJobByidCompany company;
    ...
    public GetapplyJobByidCompany getCompany() {
        return company;
    }

    public void setCompany(GetapplyJobByidCompany company) {
