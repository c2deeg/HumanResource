...
public class GetJobsDatum {

    @SerializedName("company")
    @Expose
    private GetJobsCompany company;
    ...
    @Expose
    private GetJobsCategory category;
    ...
    public GetJobsCompany getCompany() {
        return company;
    }

    public void setCompany(GetJobsCompany company) {
    ...
    public GetJobsCategory getCategory() {
        return category;
    }

    public void setCategory(GetJobsCategory category) {
